                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('permissions.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <p class="text-xs text-gray-500 mt-1">Formato recomendado: modulo.acao (ex: users.view, roles.create)</p>
                            @error('name')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="guard_name" id="guard_name" value="{{ old('guard_name', 'web') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required>
                            @error('guard_name')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
