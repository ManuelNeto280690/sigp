        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="mb-4">
                        <form action="{{ route('permissions.index') }}" method="GET" class="flex items-center space-x-4">
                            <div class="flex-1">
                    ...
                    <div class="space-y-6">
                        @forelse ($permissions as $module => $modulePermissions)
                            <div class="bg-gray-50 p-4 rounded-lg">
                                <h3 class="text-lg font-medium text-gray-900 mb-4 capitalize">{{ $module }}</h3>
                                        ...
                                        <div class="bg-white p-4 rounded-md shadow">
                                            <div class="flex justify-between items-center">
                                                ...
                                                <div class="flex space-x-2">
                                                    ...
                                                    <form action="{{ route('permissions.destroy', $permission) }}" method="POST" class="inline" onsubmit="return confirm('Tem certeza que deseja excluir esta permissão?');">
                                                        @csrf
                                                        @method('DELETE')
                        ...
                        @empty
                            <div class="bg-gray-50 p-4 rounded-lg text-center">
                                <p class="text-gray-500">Nenhuma permissão encontrada.</p>
                            </div>
                        @endforelse
                    </div>
                </div>
