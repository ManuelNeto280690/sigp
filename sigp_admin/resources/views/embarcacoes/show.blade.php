    ...
    <div class="py-4">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 ">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-3 mb-4" style="font-size: 14px;">
                ...
                <x-stat-card 
                    title="Atualizada" 
                    :value="$embarcacao->updated_at->locale('pt_BR')->diffForHumans()" 
                    color="gray" 
                    icon="fas fa-clock" 
                    class="text-xs" />
            </div>
                        ...
                        <div class="p-6">
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <a href="{{ route('embarcacoes.exportPdf', $embarcacao) }}" 
                                   class="inline-flex items-center justify-center px-4 py-2 bg-red-600 hover:bg-red-700 text-white font-medium rounded-lg transition duration-200">
                                       <i class="fas fa-file-pdf mr-2"></i>
                                       Exportar PDF
                                   </a>
                                   <a href="{{ route('entrada-saida-embarcacao.create', ['embarcacao_id' => $embarcacao->id]) }}" 
