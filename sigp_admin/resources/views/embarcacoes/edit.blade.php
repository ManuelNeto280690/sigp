    ...
    <div class="py-6">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow-lg rounded-xl overflow-hidden">
                <form method="POST" action="{{ route('embarcacoes.update', $embarcacao) }}" enctype="multipart/form-data" class="space-y-6">
                    @csrf
                    @method('PUT')
                            ...
                            <div class="md:col-span-2 space-y-2">
                                ...
                                <div class="relative">
                                    <select id="tipo_embarcacao" name="tipo_embarcacao" 
                                        ...
                                        <option value="container" {{ old('tipo_embarcacao', $embarcacao->tipo_embarcacao) == 'container' ? 'selected' : '' }}>🚢 Container</option>
                                        <option value="graneis_solidos" {{ old('tipo_embarcacao', $embarcacao->tipo_embarcacao) == 'graneis_solidos' ? 'selected' : '' }}>⚓ Granéis Sólidos</option>
                                        <option value="graneis_liquidos" {{ old('tipo_embarcacao', $embarcacao->tipo_embarcacao) == 'graneis_liquidos' ? 'selected' : '' }}>🛢️ Granéis Líquidos</option>
                                        <option value="carga_geral" {{ old('tipo_embarcacao', $embarcacao->tipo_embarcacao) == 'carga_geral' ? 'selected' : '' }}>📦 Carga Geral</option>
                                        ...
                                        <option value="ro_ro" {{ old('tipo_embarcacao', $embarcacao->tipo_embarcacao) == 'ro_ro' ? 'selected' : '' }}>🚛 Ro-Ro</option>
                                        <option value="frigorifico" {{ old('tipo_embarcacao', $embarcacao->tipo_embarcacao) == 'frigorifico' ? 'selected' : '' }}>❄️ Frigorífico</option>
                                    </select>
                                    <i class="fas fa-ship absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400"></i>
                    ...
                    <div class="p-6 bg-gradient-to-r from-purple-50 to-pink-50">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-2">
                                <x-input-label for="status" :value="__('Status da Embarcação')" class="text-sm font-medium text-gray-700" />
                                <div class="relative">
                            ...
                            <div class="space-y-2">
                                <x-input-label for="is_active" :value="__('Situação da Embarcação')" class="text-sm font-medium text-gray-700" />
                                <div class="relative">
