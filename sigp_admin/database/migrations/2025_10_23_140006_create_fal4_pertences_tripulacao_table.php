...
return new class extends Migration
{
    ...
    {
        Schema::create('fal4_pertences_tripulacao', function (Blueprint $table) {
            $table->uuid('id')->primary();
            $table->uuid('pedido_id');
            
            // Informações gerais
            $table->text('observacoes_gerais')->nullable();
            $table->boolean('possui_bens_comerciais')->default(false);
            $table->text('justificativa_bens_comerciais')->nullable();
