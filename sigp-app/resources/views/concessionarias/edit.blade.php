        ...
        <div class="flex justify-between items-center">
            <div class="flex items-center">
                ...
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                    {{ __('Editar Concessionária') }}
                </h2>
            </div>
            <div class="flex space-x-3">
                <a href="{{ route('concessionarias.show', $concessionaria) }}" class="text-white font-bold py-2 px-4 rounded-lg transition duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 flex items-center" style="background: #10b981; border: 2px solid #10b981;">
            ...
            <div class="bg-white rounded-2xl border border-gray-100 overflow-hidden shadow-lg">
                ...
                <div class="px-8 py-6 border-b border-gray-100" style="background: linear-gradient(135deg, #f8fafc 0%, #e2e8f0 100%);">
                    <h3 class="text-lg font-bold text-gray-900 flex items-center">
                        ...
                        Editar Concessionária: {{ $concessionaria->nome }}
                    </h3>
                    <p class="text-sm text-gray-600 mt-1">Atualize as informações da concessionária portuária</p>
                </div>

                <form action="{{ route('concessionarias.update', $concessionaria) }}" method="POST" class="p-8">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            ...
                            <div class="lg:col-span-2">
                                ...
                                <input type="text" 
                                       name="nome" 
                                       id="nome"
                                       value="{{ old('nome', $concessionaria->nome) }}"
                            ...
                            <div>
                                ...
                                <input type="text" 
                                       name="nif" 
                                       id="nif"
                                       value="{{ old('nif', $concessionaria->nif) }}"
                            ...
                            <div class="lg:col-span-2">
                                ...
                                <input type="email" 
                                       name="email" 
                                       id="email"
                                       value="{{ old('email', $concessionaria->email) }}"
                            ...
                            <div>
                                ...
                                <select name="user_id" 
                                    ...
                                    @foreach($users ?? [] as $user)
                                        <option value="{{ $user->id }}" {{ old('user_id', $concessionaria->user_id) == $user->id ? 'selected' : '' }}>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" 
                                       name="telefone" 
                                       id="telefone"
                                       value="{{ old('telefone', $concessionaria->telefone) }}"
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <textarea name="observacoes" 
                                          ...
                                          placeholder="Informações adicionais sobre a concessionária...">{{ old('observacoes', $concessionaria->observacoes) }}</textarea>
                                @error('observacoes')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                <label class="flex items-center">
                                    <input type="checkbox" 
                                           name="is_active" 
                                           value="1"
                                           {{ old('is_active', $concessionaria->is_active) ? 'checked' : '' }}
                    ...
                    <div class="flex items-center justify-end space-x-4 pt-6 border-t border-gray-200">
                        <a href="{{ route('concessionarias.show', $concessionaria) }}" 
