        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-2xl border border-gray-100 overflow-hidden shadow-lg">
                ...
                <div class="px-8 py-6 border-b border-gray-100" style="background: linear-gradient(135deg, #f8fafc 0%, #e2e8f0 100%);">
                    ...
                    <p class="text-sm text-gray-600 mt-1">Atualize as informações do terminal portuário</p>
                </div>

                <form action="{{ route('terminais.update', $terminal->id) }}" method="POST" class="p-8">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <select name="concessionaria_id" 
                                    ...
                                    @foreach($concessionarias ?? [] as $concessionaria)
                                        <option value="{{ $concessionaria->id }}" {{ old('concessionaria_id', $terminal->concessionaria_id) == $concessionaria->id ? 'selected' : '' }}>
                                            {{ $concessionaria->nome }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                <label for="codigo" class="block text-sm font-medium text-gray-700 mb-2">
                                    Código <span class="text-gray-500">(Não editável)</span>
                                </label>
                                <input type="text" 
                                       name="codigo" 
                                       id="codigo"
                                       ...
                                       placeholder="Ex: TCN01"
                                       maxlength="20"
                                       readonly>
                                <p class="mt-1 text-sm text-gray-500">O código do terminal não pode ser alterado após a criação</p>
                                @error('codigo')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <select name="tipo" 
                                    ...
                                    <option value="carga geral" {{ old('tipo', $terminal->tipo) == 'carga geral' ? 'selected' : '' }}>Cargas gerais</option>
                                </select>
                                @error('tipo')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <select name="status" 
                                        ...
                                        required>
                                    <option value="ativo" {{ old('status', $terminal->status) == 'ativo' ? 'selected' : '' }}>Ativo</option>
                                    <option value="inativo" {{ old('status', $terminal->status) == 'inativo' ? 'selected' : '' }}>Inativo</option>
                                    <option value="manutencao" {{ old('status', $terminal->status) == 'manutencao' ? 'selected' : '' }}>Em Manutenção</option>
                                </select>
                                @error('status')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <select name="is_active" 
                                    ...
                                    <option value="1" {{ old('is_active', $terminal->is_active) == '1' ? 'selected' : '' }}>Sim</option>
                                    <option value="0" {{ old('is_active', $terminal->is_active) == '0' ? 'selected' : '' }}>Não</option>
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            ...
                            <div>
                                ...
                                <input type="number" 
                                       name="area_total" 
                                       id="area_total"
                                       value="{{ old('area_total', $terminal->area_total) }}"
                            ...
                            <div>
                                ...
                                <input type="number" 
                                       ...
                                       id="area_operacional"
                                       value="{{ old('area_operacional', $terminal->area_operacional) }}"
                            ...
                            <div>
                                ...
                                <input type="number" 
                                       name="numero_bercos" 
                                       id="numero_bercos"
                                       value="{{ old('numero_bercos', $terminal->numero_bercos) }}"
                            ...
                            <div>
                                ...
                                <input type="number" 
                                       name="calado_maximo" 
                                       id="calado_maximo"
                                       value="{{ old('calado_maximo', $terminal->calado_maximo) }}"
                            ...
                            <div>
                                ...
                                <input type="number" 
                                       ...
                                       value="{{ old('capacidade_armazenagem', $terminal->capacidade_armazenagem) }}"
                    ...
                    <div class="mb-8">
                        ...
                        <div>
                            ...
                            <textarea name="descricao" 
                                      ...
                                      placeholder="Descreva as características e funcionalidades do terminal...">{{ old('descricao', $terminal->descricao) }}</textarea>
                            @error('descricao')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="mb-8">
                        ...
                        <div>
                            ...
                            <textarea name="observacoes" 
                                      ...
                                      placeholder="Informações adicionais sobre o terminal...">{{ old('observacoes', $terminal->observacoes) }}</textarea>
                            @error('observacoes')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
